...
if (isset($_POST['btnAdd'])) {
    ...
    if ($_FILES['image']['size'] != 0 && $_FILES['image']['error'] == 0 && !empty($_FILES['image'])) {
        ...
        $sql = "INSERT INTO free_plan_image (image) VALUES ('$upload_image')";
        $db->sql($sql);
    } 
    ...
    if ($result == 1) {
        $error['add_slide'] = "<section class='content-header'>
                                            <span class='label label-success'>Free Plan Image Added Successfully</span> </section>";
    } else {
...
<section class="content-header">
    <h1>Add Free Plan Image <small><a href='free_plan_image.php'> <i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to Free Plan Image</a></small></h1>
